...
| `ripd.md` | Relatório de Impacto à Proteção de Dados Pessoais (Art. 38) | A abrir na Fase 0, concluir e assinar antes do go-live (Fase 7) |
| `politica-de-retencao.md` | Prazos de retenção e regras de expurgo/anonimização por categoria | A definir com jurídico (ver `../OPEN-QUESTIONS.md`) |
...
- **Encarregado (DPO):** a designar na Fase 0; contato publicado na Política de Privacidade.
