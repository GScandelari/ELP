...
export function AddStudentDialog({
  ...
  return (
    <Dialog open={open} onClose={handleClose} labelledBy="add-student-title">
      ...
      {setupLink ? (
        <div className="mt-4 space-y-4">
          <p className="text-sm text-muted-foreground">
            Conta criada. Envie este link ao aluno (ou ao responsável) para ele
            definir a própria senha — a ELP ainda não envia esse e-mail
            automaticamente.
          </p>
